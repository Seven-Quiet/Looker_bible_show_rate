view: session_start_retention {
  sql_table_name: `biblia-sagrada-consigo.Bible.session_start_retention` ;;
  ...
  measure: d0_uv_sum {
    type: sum
    sql: ${uv} ;;
    filters: [event_name: "session_start", dx: "d0"]
  }

  measure: d1_uv_sum {
    type: sum
    sql: ${uv} ;;
    filters: [event_name: "session_start", dx: "d1"]
  }

  measure: d2_uv_sum {
    type: sum
    sql: ${uv} ;;
    filters: [event_name: "session_start", dx: "d2"]
  }

  measure: d3_uv_sum {
    type: sum
    sql: ${uv} ;;
    filters: [event_name: "session_start", dx: "d3"]
  }

  measure: d4_uv_sum {
    type: sum
    sql: ${uv} ;;
    filters: [event_name: "session_start", dx: "d4"]
  }

  measure: d5_uv_sum {
    type: sum
    sql: ${uv} ;;
    filters: [event_name: "session_start", dx: "d5"]
  }

  measure: d6_uv_sum {
    type: sum
    sql: ${uv} ;;
    filters: [event_name: "session_start", dx: "d6"]
  }

  measure: d7_uv_sum {
    type: sum
    sql: ${uv} ;;
    filters: [event_name: "session_start", dx: "d7"]
  }

  measure: d14_uv_sum {
    type: sum
    sql: ${uv} ;;
    filters: [event_name: "session_start", dx: "d14"]
  }
